...
CREATE TABLE `tb_jogo_compra` (
  ...
  CONSTRAINT FK_ID_TB_JOGO FOREIGN KEY (`ID_TB_JOGO`) REFERENCES `tb_jogo` (`ID_JOGO`),
  CONSTRAINT FK_ID_TB_COMPRA FOREIGN KEY (`ID_TB_COMPRA`) REFERENCES `ID_TB_COMPRA` (`tb_compra`)
);

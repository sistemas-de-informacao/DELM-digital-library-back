...
public class GameValidator {
	...
	public static Response validateDev(String desenvolvedor) {
		if (desenvolvedor.isEmpty() || desenvolvedor == null)
			return ResponseUtils.successReturnString(Response.Status.OK, "O campo desenvolvedor é obrigatário");
	...
	public static Response validateDescription(String description) {
		if (description.isEmpty() || description == null)
			return ResponseUtils.successReturnString(Response.Status.OK, "O campo descrição é obrigatário");

		if (description.length() > 500)
			return ResponseUtils.successReturnString(Response.Status.OK,
					"O campo descricão só pode ter no máximo 500 caracteres");
	...
	public static Response validateCategory(Integer categoria) {
		if (categoria == null)
			return ResponseUtils.successReturnString(Response.Status.OK, "O campo categoria é obrigatário");
